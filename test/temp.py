...
def msg_img(ref_image, secret_txt):
    ...
    font = ImageFont.truetype("WorkSans-Italic-VariableFont_wght.ttf", 80)
    margin = offset = 10
...
# encoding_msg("sample.png", "Hello my name is Priyam and i am a ML enthusiast. Lorem ipsusum jahsgdfa ihaf;ija ihaifjdpifh hawph;oij aosijjf af a f")
